...
local DOC = P {
	...
	LUA_FUNC = C(P"function" * ((1 - (NEWLINE + V("LUA_FUNC_ENDING")))^1 * (NEWLINE - V("LUA_FUNC_ENDING"))^0)^0 * #V("LUA_FUNC_ENDING") * P("end")) / 
	function(v)
...
check_type = function(type, specifier)
	if ctypes[type] then
