...
require("math")
local EXPORT_ASSERT_TO_GLOBALS = rawget(_G, "EXPORT_ASSERT_TO_GLOBALS")
local LuaUnit = rawget(_G, "LuaUnit")
local jit = rawget(_G, "jit")
Lib.declare("setupSuite", rawget(_G, "setupSuite"))
Lib.declare("teardownSuite", rawget(_G, "teardownSuite"))
local M={}
